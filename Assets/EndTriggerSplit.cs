...
public class EndTriggerSplit : MonoBehaviour
{
   public TriggerToDialogue ttd;
    ...
    void Update()
    {
            ...
            if(timeSinceTrigger > 5f && done == false){
                ...
                var boxToSpawn = ttd.dbox("You're always welcome in our tavern!");
    ...
    void OnTriggerEnter2D(Collider2D col){
        if (col.gameObject.name == "Player" && triggered == false){
            ...
            triggered = true;
            var boxToSpawn = ttd.dbox("Thanks for helping keep our town safe traveller! I hope you and Jonton are good friends now!");
            Instantiate(boxToSpawn, talker.transform);
        }
